...
Version  : 1.13.4
Release  : 41
URL      : https://cran.r-project.org/src/contrib/data.table_1.13.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/data.table_1.13.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607542090
