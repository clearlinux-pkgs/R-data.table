...
Version  : 1.14.6
Release  : 62
URL      : https://cran.r-project.org/src/contrib/data.table_1.14.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/data.table_1.14.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668648830
