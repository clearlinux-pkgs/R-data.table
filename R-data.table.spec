...
Version  : 1.17.2
Release  : 80
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/data.table_1.17.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/data.table_1.17.2.tar.gz
...
%package dev
Summary: dev components for the R-data.table package.
Group: Development
Requires: R-data.table-lib = %{version}-%{release}
Provides: R-data.table-devel = %{version}-%{release}
Requires: R-data.table = %{version}-%{release}

%description dev
dev components for the R-data.table package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747147902
...
/usr/lib64/R/library/data.table/tests/S4.R
/usr/lib64/R/library/data.table/tests/S4.Rraw.bz2
...
/usr/lib64/R/library/data.table/tests/ch11b.dat.bgz
