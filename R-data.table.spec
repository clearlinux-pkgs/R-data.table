...
Source0  : https://cran.r-project.org/src/contrib/data.table_1.12.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570110452
...
/usr/lib64/R/library/data.table/tests/melt_1754_synth.csv
