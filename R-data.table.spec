...
Version  : 1.15.2
Release  : 71
URL      : https://cran.r-project.org/src/contrib/data.table_1.15.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/data.table_1.15.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709233244
